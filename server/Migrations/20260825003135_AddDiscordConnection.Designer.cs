...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Data.Entities.AppSettingsItem", b =>
                {
                    ...
                    b.ToTable("AppSettings", "administration");
                });
            ...
            modelBuilder.Entity("server.Data.Entities.DiscordConnection", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DiscordConnections", "public");
                });
            ...
            modelBuilder.Entity("server.Data.Entities.AttendanceEntry", b =>
                {
                    ...
                    b.HasOne("server.Data.Entities.Account", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("server.Data.Entities.DiscordConnection", b =>
                {
                    b.HasOne("server.Data.Entities.Account", "Account")
                        ...
                        .HasForeignKey("server.Data.Entities.DiscordConnection", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
